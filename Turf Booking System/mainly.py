...
try:
    ...
    py3 = True
def click_booking():
    call(["python", "booking_gui_and_program.py"])
def click_list():
    call(["python", "listgui.py"])
def click_checkout():
    call(["python", "leavingGui.py"])
def click_getinfo():
    call(["python","getinfoui.py"])


class TURF_MANAGEMENT:
    def _init_(self):
        root = Tk()
        ...
        self.Message6.configure(text='''SIMPLY TURF''')
        ...
        self.Button2.configure(text='''1.BOOKING''')
        self.Button2.configure(width=566)
        self.Button2.configure(command=click_booking)
        ...
        self.Button3.configure(text='''2.SHOW PLAYER LIST''')
        ...
        self.Button4.configure(text='''3.PLAYERS LEAVING''')
        ...
        self.Button5.configure(text='''4.GET INFO OF ANY PLAYER''')
