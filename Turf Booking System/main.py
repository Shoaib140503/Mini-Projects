...
def chk_day():
    while True:
        print("\n")
        no_of_days = input("ENTER NO. OF HOURS :")
...
def chk_pay():
    while True:
        print("\n")
        op = input("Enter player's choice:")
        a = op.isdigit()
...
class save:
    ...
    def tor(self):
        ...
        print("4. golf")
        while True:
            ch = input("Enter player's choice:")
            a = ch.isdigit()
...
while True:
    ...
    print("3.Check out")
    print("4.get info of any Player")
    print("5.EXIT")
