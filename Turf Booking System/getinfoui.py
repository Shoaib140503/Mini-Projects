    ...
    def _init_(self):
        def gotinfo():
            ...
            if self.gettininfo.isdigit() == True and len(self.gettininfo) != 0:
                self.Text1.insert(INSERT, " valid player number ""\n")
            else :
                self.Text1.insert(INSERT,"invalid player number""\n")
            ...
            try:
                ...
                while True:
                    ...
                    if self.gettininfo == a:
                        ...
                        if n == 0:
                            print("NO PLAYER  ", self.gettininfo)
                        else:
                            n = 0
                            continue
            except EOFError:
        ...
        self.Label1.configure(text='''ENTER THE PLAYER NO.   :''')
